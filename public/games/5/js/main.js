...
mit.main = function() {
  ...
  */
  ...
  tweet.href='../../games.html';

  var facebook = document.getElementById("fb");
  facebook.href='leader.html';
  ...
  mit.gameOver = function() {
    ...
    if (mit.score > mit.highScore) {
      if(ki==0)
      {
        ...
        // document.getElementById("start_li").innerHTML="<a href="index.html">YOOO</a>";
      }
