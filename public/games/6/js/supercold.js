...
GameStorageManager.prototype.saveLevel = function(level) {
    level = Number(level);
    console.log("2//205//level="+level);//POST
    var supercold_hs=localStorage.getItem('supercold_hs');
    if(supercold_hs==null)
    {
        supercold_hs=0;
        localStorage.setItem("supercold_hs",0);
    }
    else if(level>supercold_hs)
    {
        ...
        localStorage.setItem("supercold_hs",level);
    }
...
Supercold.Intro.prototype.create = function() {
    ...
    this._announcer = new Announcer(this.game, Supercold.texts.SUPERCOLD, {
        ...
        onComplete: (function startLevel() {
            // console.log("/2//1784//level"+JSON.stringify(level));
